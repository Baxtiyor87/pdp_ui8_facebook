                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text(userName, style: TextStyle(color: Colors.grey[500], fontSize: 18, fontWeight: FontWeight.bold, letterSpacing: 1),),
                            SizedBox(height: 3,),
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    ...
                    SizedBox(width: 5,),
                    Text("2.5K", style: TextStyle(fontSize: 15, color: Colors.grey[700]),)
                  ],
                ),
